...
SECRET_KEY = 'django-insecure-g&paj&_s_r_1tc7^#r0-ly*%dw5pf8d+++92)*^rz3d&@yfrjb'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'moielist',  # Your db name, Or path to database file if using sqlite3
        'USER': 'root',  # Your db user name, Not used with sqlite3
        'PASSWORD': 'root',  # Your db password, Not used with sqlite3
